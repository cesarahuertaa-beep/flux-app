        ...
        {mode === "signup_civil" && <>
          ...
          <div className="mb-4 flex items-start gap-2">
            ...
            <label htmlFor="aviso_civil" className="text-xs text-[#6B7A8D] leading-tight cursor-pointer">
              He leído y acepto el <a href="https://flux-sport.com/privacidad" target="_blank" rel="noopener noreferrer" className="text-[#1A6FD4] underline">Aviso de Privacidad</a> para el tratamiento de mis datos personales y de salud.
            </label>
          </div>
