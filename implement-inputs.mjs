...
const regex = /<div key=\{si\} className="flex gap-2 mb-2 items-center">([\s\S]*?)<\!-- 🏋️ Status Icon 🏋️ -->/g;

// Instead of regex, let's just split and re-join since it's cleaner to locate the exact string.
const oldString = `                      return (
